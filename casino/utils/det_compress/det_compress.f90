PROGRAM det_compress
 ...
 INTEGER,POINTER :: tmp_idet_eff(:)=>null(),temp_orbmap_iop(:,:)=>null(),&
  &temp_orbmap_jop(:,:)=>null()
...
CONTAINS
 ...
 REAL(dp) t1,t2
 ! Work pointers.
! Moved to module declarations MDT 2.2014
! INTEGER,POINTER :: tmp_idet_eff(:)=>null()
 INTEGER,POINTER :: dedup_idetlabel(:,:)=>null()
